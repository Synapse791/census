...
func Read(message string, args... interface{}) string {
  var data string
  formattedMessage := fmt.Sprintf(message, args...)
  fmt.Fprintf(os.Stdout, "[\033[36m%s\033[00m]  \033[36m%s: \033[00m", getTimestamp(), formattedMessage)
  fmt.Scan(&data)
  return data
}
...
func Success(message string, args... interface{}) {
  formattedMessage := fmt.Sprintf(message, args...)
  fmt.Fprintf(os.Stdout, "[\033[32m%s\033[00m]  [\033[32mSUCC\033[00m]  \033[32m%s\033[00m\n", getTimestamp(), formattedMessage)
}

func Warning(message string, args... interface{}) {
  formattedMessage := fmt.Sprintf(message, args...)
  fmt.Fprintf(os.Stderr, "[\033[33m%s\033[00m]  [\033[33mWARN\033[00m]  \033[33m%s\033[00m\n", getTimestamp(), formattedMessage)
}
